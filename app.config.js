...
export default {
  expo: {
    ...
    ios: {
      supportsTablet: true,
      bundleIdentifier: "com.realstate.canaletto",
      infoPlist: {
    ...
    android: {
      package: "com.realstate.canaletto",
    ...
    plugins: [
      ...
      [
        "expo-location",
        {
          locationAlwaysAndWhenInUsePermission:
            "Allow Canaletto to use your location to show nearby services and connect you with local providers.",
          locationAlwaysPermission:
            "Allow Canaletto to use your location in the background to notify you of service opportunities in your area.",
          locationWhenInUsePermission:
            "Allow Canaletto to use your location while using the app to show nearby services.",
      ...
      [
        ...
        {
          photosPermission:
            "Canaletto needs access to your photos to allow you to upload documents and photos related to your services.",
        },
      ],
